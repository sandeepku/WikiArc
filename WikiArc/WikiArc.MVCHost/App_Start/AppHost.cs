...
[assembly: WebActivator.PreApplicationStartMethod(typeof(WikiArc.MVCHost.App_Start.AppHost), "Start")]
...
namespace WikiArc.MVCHost.App_Start
{
		...
		: AppHostBase
	{
		...
		public override void Configure(Funq.Container container)
		{
           ...
           // Plugins.Add(new RazorFormat());
			...
			//sandeep disable this one for now container.Register(new TodoRepository());			
